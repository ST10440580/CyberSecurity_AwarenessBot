...
-User can now add tasks and set reminder 
-User can now access activity log to view their activity 
-Upgraded look to the program
-User can now take a quiz game that tests their knowledge 
